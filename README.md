...
* Команда /top разделена на категории.
* Добавлен топ по количеству выпитой водки в чате (/top_vodka).
* Добавлена команда /eda.
* Добавлен топ по сытости в чате (/top_eda).
