...
CREATE TABLE `help` (
  ...
  PRIMARY KEY (`id`),
  KEY `id` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb3 COMMENT='Таблица с тектом помощи';
...
CREATE TABLE `updates` (
  ...
  PRIMARY KEY (`id`),
  KEY `id` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb3 COMMENT='Таблица с текстом обновлений';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `updates` VALUES (1,'<b>Обновление 0.1</b>\r\n\r\n- Добавлена команда просмотра команд - <i>/help</i>.\r\n- Добавлена команда просмотра личной статистики - <i>/mystats</i>.\r\n- Добавлена команда просмотра статистики чата - <i>/stats</i>.\r\n- Добавлен счётчик сообщений, голосовых сообщений, видео, аудио, фото, документов, стикеров и видео сообщений.\r\n- Добавлено подключение к базе данных.\r\n- Добавлено подключение к боту.'),(2,'<b>Обновление 0.1.1</b>\r\n\r\n- Исправлена ошибка при выводе статистики с нулевым днём регистрации чата/участника.'),(3,'<b>Обновление 0.2</b>\r\n\r\n- Добавлена команда с просмотром рейтинга 10 пользователей по количеству сообщений - <i>/top</i>.\r\n- Добавлена команда с просмотром последних 5-ти обновлений бота - <i>/updates</i>.'),(4,'<b>Обновление 0.3</b>\r\n\r\n- Добавлена поддержка разметки текста.\r\n- Добавлена загрузка текста для команды <i>/help</i> из базы данных.'),(5,'<b>Обновление 0.3.1</b>\r\n\r\n- Исправлено корректное отображение среднего количества сообщений.'),(6,'<b>Обновление 0.3.2</b>\r\n\r\n- Бот отправляет бесшумные сообщения, не вызывая звук при упоминании участников чата.'),(7,'<b>Обновление 0.4</b>\r\n\r\n- Добавлена команда для управления внутренним никнеймом в чате - <i>/nick</i>.\r\n- Добавлена команда для упоминания всех участников чата - <i>/all</i>'),(8,'<b>Обновление 0.4.1</b>\r\n\r\n- Исправлено некорректное упоминание участников чата.'),(9,'<b>Обновление 0.5</b>\r\n\r\n- Добавлена команда для вывода случайного анекдота - <i>/anek</i>.\r\n- Рефакторинг SQL запросов.');
...
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb3 COMMENT='Таблица с информацией о пользователях';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2022-08-30  0:50:37