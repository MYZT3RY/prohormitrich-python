...
def cmdMyStats(update: Update, context: CallbackContext):
    ...
    string = "<b>Личная статистика в чате - {0}</b>\n\nДата регистрации в чате: <b>{1}</b>\n\nСообщений: <b>{2}</b>\nГолосовых сообщений: <b>{3}</b>\nВидео сообщений: <b>{4}</b>\nВидеозаписи: <b>{5}</b>\nАудиозаписи: <b>{6}</b>\nФотографий: <b>{7}</b>\nДокументов: <b>{8}</b>\nСтикеров: <b>{9}</b>\nОтредактированных сообщений: <b>{10}</b>\n\nСреднее количество сообщений в день: <b>{11:.2f}</b>\n\nВыпито водки: <b>{12:.1f} л.</b>".format(tgChatName, row["dateOfRegister"], row["messages"], row["voices"], row["videovoices"], row["videos"], row["audios"], row["photos"], row["documents"], row["stickers"], row["edited_messages"], messagesPerDay, row["vodka_drinked"])
